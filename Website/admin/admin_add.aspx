<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminNotAJAX.Master" AutoEventWireup="true" CodeBehind="admin_add.aspx.cs" Inherits="Website.admin.admin_add" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Text" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td style="width:20%; text-align:left; " >
                <asp:CheckBox ID="chkLogin" runat="server" Text="Cho phép đăng nhập" />                
            </td>
            <td style="width:20%">               
            </td>
            <td style="width:15%"></td>
