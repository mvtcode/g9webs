<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminNotAJAX.Master" AutoEventWireup="true" CodeBehind="customer_manager.aspx.cs" Inherits="Website.admin.customer_manager" %>
                    ...
                    <tr>
                        ...
                        <td align="right" style="width: 50%; text-align: right">
                            <asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click"
                                Width="40px" OnClientClick="javascript:{ return confirm('Bạn có muốn xóa khách hàng được chọn?');}" />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="text-align: center">
                <asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="s_CustomerName" HeaderText="Tên khách hàng"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />                        
                            <asp:BoundField DataField="s_Address" HeaderText="Địa chỉ"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />                        
                            <asp:BoundField DataField="s_Mobile" HeaderText="Mobile"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />                        
                            <asp:BoundField DataField="s_Email" HeaderText="Email"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />                        
                            <asp:BoundField DataField="s_Homepage" HeaderText="Homepage"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />                        
