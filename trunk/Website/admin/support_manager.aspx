<%@ Page Title="" Language="C#" MasterPageFile="~/admin/master_default.master" AutoEventWireup="true" CodeBehind="support_manager.aspx.cs" Inherits="Website.admin.support_manager" %>
                ...
                <asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="s_Name" HeaderText="Tên Người hỗ trợ"
                            ...
                            <asp:BoundField DataField="s_Yahoo" HeaderText="Yahoo"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />
                            
                            <asp:BoundField DataField="s_Skype" HeaderText="Skype"
                            HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left" />                           
